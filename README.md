...
#### 1.4.1 Configure SSL certificates for K8s ingress
...
#### 1.4.2 Modify k8s_cluster_config.bash
...
#### 1.4.3 Run k8s_cluster_config.bash script
...
### 1.5 Install Java 17, Docker, Maven

### 1.6 Configure k8s_redeploy.bash script
...
### 2.5 OpenAPI-Generator configuration
...
### 2.7 Kubernetes deployment and configuration
